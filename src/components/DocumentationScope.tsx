        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((item, idx) => (
            <motion.div
              ...
              className="p-8 rounded-3xl border border-slate-100 bg-white hover:border-[#008751]/20 hover:shadow-xl hover:shadow-slate-200/50 transition-all group"
            >
              <div className="w-14 h-14 bg-[#008751]/5 text-[#008751] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#008751] group-hover:text-white transition-all">
                <item.icon size={28} />
              </div>
